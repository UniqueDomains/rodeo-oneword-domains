# Available .RODEO One-Word Domains (5,621,983)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-9%2C537%20rows-8250df">
...
> **Important:** this repository is a **public 9,537-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,983 domains** on the canonical page below.

**Public extract:** 9,537 rows · **Live catalog:** 5,621,983 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/rodeo?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/rodeo?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./rodeo.csv">CSV</a> / <a href="./rodeo.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .RODEO search](https://unique.domains/domains/tld/rodeo?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .RODEO search](https://unique.domains/domains/tld/rodeo?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_rodeo_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./rodeo.csv) or [Download JSON](./rodeo.json)
...
- `rodeo.csv` — public CSV extract (9,537 rows)
- `rodeo.json` — public JSON extract (9,537 rows)
...
| ----------------------- | ------------------------------------------------ |
| 9,537-row public sample | 5,621,983 live domains                           |
...
| clear.rodeo     | available | $13.28    | —             | 90             | 50     | 5      | namecheap        |
| buy.rodeo       | resell    | —         | —             | 106            | 56     | 3      | GoDaddy.com, LLC |
| ace.rodeo       | premium   | $100      | $14.99        | 88             | 57     | 3      | name.com         |
| genius.rodeo    | available | $13.28    | —             | 98             | 47     | 6      | namecheap        |
| startup.rodeo   | resell    | —         | —             | 82             | 48     | 7      | GoDaddy.com, LLC |
| live.rodeo      | premium   | $100      | $14.99        | 108            | 55     | 4      | name.com         |
...
| health.rodeo    | resell    | —         | —             | 92             | 45     | 6      | Porkbun          |
...
> Unique Domains. *Available .RODEO One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
